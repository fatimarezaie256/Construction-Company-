...
export default function Contact(){
  ...
  <WholeWordIcon className="h-6 w-6 text-white" />
        ...
        <div className="">
         <div className="flex gap-52  pt-12">
         <div className="-ml-64">
            <label className="block ">YOUR NAME</label>
            < input className="border w-[182%]  focus:outline-0 p-2 rounded-md bg-[#193356] border-[#466387]" type="text" placeholder="Name *"/>
         </div>
         <div  className="">
            <label className="block">YOUR EMAIL</label>
            < input className="border-[1px] focus:outline-0  border-[#466387] w-[182%] p-2 rounded-md bg-[#193356] " type="text" placeholder="Your email *"/>
         </div>
